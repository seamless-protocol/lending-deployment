...
import {IRewardsDistributor} from 'seamless/aave-v3-periphery/rewards/interfaces/IRewardsDistributor.sol';
...
abstract contract RewardsDistributor is IRewardsDistributor {
  ...
  function _updateUserData(
    ...
    // console.log("indexes", userIndex, newAssetIndex);
  ...
  function _updateData(
    ...
    unchecked {
      for (uint128 r = 0; r < numAvailableRewards; r++) {
        ...
        // console.log(r, numAvailableRewards, reward);
        ...
        // console.log(newAssetIndex, rewardDataUpdated);
        ...
        // console.log(rewardsAccrued, userDataUpdated);
